...
cur = conn.cursor()
csv_data = pd.read_csv('df_for_webapp.csv')
for idx, u in csv_data.iterrows():
  cur.execute('''INSERT INTO food_atlas (id,fips,state,county,pct_laccess_pop15,pct_laccess_lowi15,pct_laccess_hhnv15,pct_laccess_snap15,pct_laccess_child15,pct_laccess_seniors15,pct_laccess_white15,pct_laccess_black15,pct_laccess_hisp15,pct_laccess_nhasian15,pct_laccess_nhna15,pct_laccess_nhpi15,pct_laccess_multir15,grocpth14,supercpth14,convspth14,specspth14,snapspth16,ffrpth14,fsrpth14,pct_snap16,pct_nslp15,pct_sbp15,pct_sfsp15,pct_wic15,sodatax_stores14,sodatax_vendm14,chipstax_stores14,chipstax_vendm14,food_tax14,fmrktpth16,pct_fmrkt_snap16,pct_fmrkt_wic16,pct_fmrkt_wiccash16,pct_fmrkt_sfmnp16,pct_fmrkt_credit16,pct_fmrkt_frveg16,pct_fmrkt_anmlprod16,pct_fmrkt_baked16,pct_fmrkt_otherfood16,foodhub16,pct_diabetes_adults13,pct_obese_adults13,pct_hspa15,recfacpth14,pct_nhwhite10,pct_nhblack10,pct_hisp10,pct_nhasian10,pct_nhna10,pct_nhpi10,pct_65older10,pct_18younger10,medhhinc15,povrate15,metro13)
